...
assert_file_has_content $FL_DIR/exports/share/thumbnailers/org.test.Hello.thumbnailer "^Exec=.*flatpak run --branch=master --arch=$ARCH --file-forwarding --command=hello\\.sh org\\.test\\.Hello @@ %i @@ @@ %o @@$"
